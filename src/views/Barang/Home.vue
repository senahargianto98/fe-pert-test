      ...
      <div class="app-wrapper">
        <div class="app-content pt-3 p-md-3 p-lg-4">
          <div class="container-xl">
            ...
            >
              <div class="col-auto">
                <h1 class="app-page-title mb-0">My Data</h1>
              </div>
              <!--//col-auto-->
            </div>
            <!--//row-->
                ...
                <div class="app-card app-card-settings shadow-sm p-4">
                  <div class="app-card-body">
                    <form class="settings-form">
                      ...
                      <v-btn elevation="2" @click="postdata">Save</v-btn>
                    </form>
                  </div>
                  <!--//app-card-body-->
                </div>
  ...
  methods: {
    ...
    async getEdit() {
      if (this.$route.params.id) {
        try {
          const response = await axios.get(`https://api.belajaryuk.xyz/detail/${this.$route.params.id}`);
    ...
    async postdata() {
      ...
      try {
        const response = await axios.post(
          `https://api.belajaryuk.xyz/create/barang`,
          formData,
          {
            headers: {
